...
export default function Kartu({unit, description, price, interior, size, status}) {
  return (
    <>
      <div className="row m-3 p-2 bg-white border rounded">
        ...
        <div className="align-items-center align-content-center row-md-3 border-left mt-1">
          <div className="d-flex flex-column align-items-center">
            <h4 className="mr-1">IDR {price}</h4>
          </div>
          <h6 className="text-success d-flex flex-column align-items-center">{status}</h6>
